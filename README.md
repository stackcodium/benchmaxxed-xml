...
- **[Open the complete-walk HTML report](https://stackcodium.github.io/benchmaxxed-xml/reports/latest/xml-parser-report.html)**

Captured `2026-08-22T11:19:31.021703+00:00` on `x86_64`; parser revision
`05b21ed3c`.
...
|---|---:|---:|---:|
| Benchmaxxed XML | 1535.3 | 1410.2 | 1105.6 |
| pugixml | 974.0 | 861.8 | 744.1 |
| quick-xml | 764.8 | 648.9 | 586.0 |
| Bun XML | 138.0 | 127.8 | 144.7 |
| PHP libxml2 | 109.0 | 86.3 | 92.2 |
| Python libxml2 | 59.3 | 55.1 | 49.6 |
...
For the complete six-parser run, including the pinned Bun build and the PHP/Python libxml2
adapters, see
...
|---|---|---|
| Benchmaxxed XML | `05b21ed3c7d2c9630e2cb2bd77d6999160cced31` (clean source) | [Included source](parser/) |
...
| Bun XML | `1.4.0+34cbb9a40` / `34cbb9a40b4bd1bd767d134a7065e66c2432a676` | [GitHub](https://github.com/oven-sh/bun) |
| PHP libxml2 | `8.5.9` | [Included adapter](benchmarks/php-xml-bench.php) |
| Python libxml2 | `Python 3.13.14` | [Included adapter](benchmarks/python-xml-bench.py) |

Reference repositories are not vendored. `scripts/fetch-references.sh` clones and checks out the
exact revisions above. Bun is installed separately and its runtime version is checked before the
included configuration runs. Publication additionally requires a clean parser checkout and passing
strict export and package verification.
...
`XML.parse(input, { compact: false })` followed by a JavaScript tree walk. PHP and Python call
libxml2 with `XML_PARSE_NOBLANKS | XML_PARSE_NONET | XML_PARSE_COMPACT` through FFI/ctypes and walk
the resulting tree. These are deliberately documented operating modes, not claims that every
parser exposes identical validation behavior.
